...
import 'package:foode_waste_app_1/pages/transaction_history_page.dart';
import 'package:foode_waste_app_1/pages/donation_history_page.dart';  // Tambahkan import halaman history donasi
...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> _pages = [
      ...
      // Page 1: Jika Penjual, tampilkan DonationPage + tombol Lihat Riwayat Donasi
      if (userRole == 'Penjual')
        Column(
          children: [
            Expanded(child: DonationPage(isSeller: true)),
            Padding(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Lihat Riwayat Donasi'),
              ),
            ),
          ],
        )
